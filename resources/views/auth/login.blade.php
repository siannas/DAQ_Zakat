                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="POST" action="{{ route('login')}}" id="login-form">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <a href="{{ route('login') }}" class="btn btn-primary btn-user btn-block" onclick="event.preventDefault();document.getElementById('login-form').submit();">
                                                Login
                                            </a>
                                        </div>
                                        <hr>
